...
const CycleView = ({
    ...
    const getCycleDay = (date) => {
        ...
        // Formule corrigée : ajouter +1 pour compter de 1 à cycleLength au lieu de 0 à cycleLength-1
                            ...
                            return (
                                <>
                                    <div className="text-center mb-3 md:mb-4">
                                        ...
                                        <div className="text-[15px] md:text-[16px] text-gray-500">
                                            {date.toLocaleDateString('fr-FR', { weekday: 'short', day: 'numeric', month: 'short' })}
                                        </div>
                                        <div className="text-[14px] md:text-[15px] text-gray-400 mt-1">
                                            {moonInfo.emoji} {moonInfo.name}
                                        </div>
                                        <div className="text-[13px] md:text-[14px] text-gray-400 mt-0.5">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-2 md:py-3 mb-2 md:mb-4 bg-pink-500 text-white rounded-md border-0 cursor-pointer text-[15px] md:text-[16px] font-semibold flex items-center justify-center gap-1 hover:bg-pink-600 transition-colors"
                                    >
                                        <PlusIcon />
                                        Ajouter événement
                                    </button>
                                                    ...
                                                    <div className="flex items-center gap-1.5 flex-1">
                                                        ...
                                                        <span className="flex-1">
                                                            ...
                                                            {act.isTask && act.taskListTitle && (
                                                                <span className="opacity-80 text-[13px] ml-1">
                                                                    ({act.taskListTitle})
                                                                </span>
                                                            )}
                                                        </span>
